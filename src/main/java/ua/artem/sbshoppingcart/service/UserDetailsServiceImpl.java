package ua.artem.sbshoppingcart.service;

import ua.artem.sbshoppingcart.dao.AccountDAO;
import ua.artem.sbshoppingcart.entity.Account;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        /*
        * GrantedAuthority отражает разрешения
        * выданные пользователю в масштабе всего приложения,
